...
<body class="page-property" id="page-top">
    ...
    <!-- boton down -->
    <!-- <a href="#" class="scrollup"><i class="fa fa-chevron-down" aria-hidden="true"></i></div> -->
       ...
       <?php include "botones.php" ?>
		...
		<div id="page-content">
			<div class="wide_container_2">
				<img src="assets/img/032.jpg" class="banner">
                
                <div class="container">
                	<h2 style="margin-bottom:30px;">Proyectos destacados</h2>
                    
                	<div class="col-md-3">
                    	<a href="proyecto.php" class="proyecto_box">
                        	<div class="title_proyecto">Paseo Bolívar</div>
                        	<img src="assets/img/033.jpg" />
                            <hr>
                            <div class="data_proyecto">
                            	Desde $ 105.400.000<br>
                                63 m2 y 71 m2<br>
                                Tel: 444 24 60
                            </div>
                        </a>
