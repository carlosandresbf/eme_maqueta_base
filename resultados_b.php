        ...
        <div id="page-content-search">
			<div class="wide_container_2">
				<div class="tabs colored_tabs">
                	<ul class="tab-links tabs_arriendos col-lg-12 col-md-12">
						<li class="col-md-15 col-sm-6 col-xs-12 active"><a href="#tab_a">Inmuebles</a></li>
						<li class="col-md-15 col-sm-6 col-xs-12"><a href="#tab_b">Pago y consulta de cuentas</a></li>
						<li class="col-md-15 col-sm-6 col-xs-12"><a href="#tab_c">Proceso y documentos</a></li>
						<li class="col-md-15 col-sm-6 col-xs-12"><a href="#tab_d">Consigna tu inmueble</a></li>
                        <li class="col-md-15 col-sm-6 col-xs-12"><a href="#tab_e">Mantenimiento</a></li>
					</ul>
                                                        ...
                                                        <div class="col-md-10 col-md-offset-1">
                                                            ...
                                                            <div class="explore_grid">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xs-12">
                                                                        <h2>Inmuebles para el arriendo</h2>
                                                                    </div>
                                                                    <form method="post">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-3 col-sm-3 col-xs-6 prop">
                                                                        <div class="item_house">
                                                                            ...
                                                                            <div class="house_price">Canon : $104.000.00</div>
                                                                        </div>
                                                                    </div>
                                ...
                                <div class="row" style="padding-bottom:50px">
                                    ...
                                    <div class="col-md-7">
                                        <form id="form-submit" class="form-submit clearfix" action="thank_you_page.html">
                                            ...
                                            <h3 style="margin-left:10px">Información del :</h3>
                                            
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <select name="Tipo" class="selectize-input tipo_select">
                                                        <option value="">Plomería</option>
                                                        <option value="Casa">Carpintería</option>
                                                        <option value="Local">Electricidad</option>
                                                        <option value="Bodega">Albañil</option>
                                                   </select>
                                                </div>
                                            </div>
                                             <div class="col-md-12">
